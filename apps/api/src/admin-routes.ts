...
app.get("/v1/admin/summary",{preHandler:requireRoles("ADMIN")},async()=>{const [users,candidates,companies,vacancies,payments,revenue,newToday,newWeek,expiring]=await Promise.all([
